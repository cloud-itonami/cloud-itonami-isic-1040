# Operator Quickstart — Oils and Fats Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1040** (`cloud-itonami-isic-1040`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1040.git
...
- Blueprint governor key: `oils-fats-governor`
- Likely source path: `oilsfats.governor.cljc`
